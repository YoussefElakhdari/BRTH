...
export default function PhotosUploader({ addedPhotos, onChange }) {
  ...
  async function uploadFileToCloudinary(file) {
    try {
      ...
      data.append("upload_preset", "ucq9f2lg");
      data.append("cloud_name", "ddrowsvy5");
      fetch("https://api.cloudinary.com/v1_1/ddrowsvy5/image/upload", {
        method: "POST",
        body: data,
      })
      .then((res) => {
      ...
      .then((data) => {
        if (data && data.secure_url) {
          const filename = data.secure_url;
